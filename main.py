...
for games in available_game_lt:
        try:
            ...
            driver.get('https://store.steampowered.com/')
            print("Get " + games + " Succeed")
        except:
            CurrentGame = driver.find_element_by_xpath('/html/body/div[1]/div[7]/div[4]/div[1]/div[2]/div[2]/div[2]/div/div[3]').get_attribute("innerHTML")
